...
<head>
    ...
    <script type="text/javascript">  
         function openulr(newurl) 
            {  
               if (confirm("Hello, go and check your mails for the confirmation and type your new password"))
            {    
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                ...
                <div id="recoverform">
                    ...
                    <div class="row m-t-20">
                        <!-- Form -->
                        <form class="col-12" action="javascript:openulr('authentication-login.php');">
                            <!-- email -->
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
