<?php 
    ...
    $connect = mysqli_connect("localhost", "root", "", "brandon");
    ...
    //die("failed to query data");
        ...
        if($row['Username']==$name && $row['Password']==$password){
            header("location: http://localhost/brandon/html/admin/index.php");
        }
        else{
...
<head>
    ...
    <script type="text/javascript">  function openulr(newurl) {  if (confirm("Hello, go and check your mails for the confirmation and type your new password")) {    document.location = newurl;  }}</script>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" method="POST" action="http://localhost/brandon/html/admin/process.php">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <input class="btn btn-success float-right" type="submit" name="admin" value="Login" >
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="recoverform">
                    ...
                    <div class="row m-t-20">
                        <!-- Form -->
                        <form class="col-12" action="javascript:openulr('authentication-login.html');">
                            <!-- email -->
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
