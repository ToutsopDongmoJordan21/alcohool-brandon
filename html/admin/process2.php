...
if(isset($_POST['submit']))
{
   ...
   $amount=$_POST['name2'];
        ...
        $query="INSERT INTO `account`(`Name`, `password`, `amount`) VALUES ('$name','$password','$amount')";
        $result=mysqli_query($connect,$query);
     
        if($result){
                
            echo '<script type="text/javascript">alert("Transaction successfully! End of inscription")</script>';
